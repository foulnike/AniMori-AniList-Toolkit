...
//
// Режима второй платформы в этом файле больше нет. Прежний десктоп вставлял тот же
// код скрипта в чужую страницу внутри своего окна, и от этой реализации мы отказались
// целиком. Новый клиент рисует свои экраны и собирается своим конфигом в своём месте.
//
