...
//
// Пункт 3.6б: живёт в слое скрипта, а не в ядре. Подмена слов нужна только
// тому, кто живёт внутри чужой страницы; свои экраны по-русски сразу.
// Старое имя `@/core/dictionary` сведено сюда алиасом — так же, как с lifecycle.
