...
//
// Облачная копия живёт своим узлом — components/CloudBox.vue. С двумя
// местами хранения панель выросла вдвое, а этот файл и без неё самый
// большой в приложении. Наружу узлу нужны только число записей и метка
// устройства, а обратно — весть, что список сменился.
//
  ...
  <section class="am-page">
    <div class="am-set">
      ...
      <div class="am-set__col">
        ...
        <!-- Облачная копия своим узлом: выбор места, вход и копия туда
             и обратно живут в components/CloudBox.vue. Ему нужны только
             число записей для вопросов и метка устройства для файла копии,
             а обратно приходит весть, что список сменился. -->
