  ...
  <section class="am-page">
    <div class="am-split">
      ...
      <div class="am-panel am-box">
        ...
        <p class="am-meta">
          Остальные настройки, словарь и свои ссылки переедут сюда в пункте 3.6. Кнопка «Открыть
          настоящий сайт» появится в пункте 3.7: само окно и команда для него уже готовы.
        </p>
      </div>
    </div>
  </section>
