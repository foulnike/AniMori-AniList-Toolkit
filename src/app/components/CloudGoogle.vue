...
<template>
  <div class="am-gauth">
    ...
    <template v-if="signed">
      <p class="am-meta">
        Вход пройден. Программа просила одну область — скрытую папку приложения:
    ...
    <template v-else>
      ...
      <p v-else class="am-meta">
        ...
        клавиатура, ни браузер на этом устройстве не понадобятся. Просим одну область: скрытую
        папку приложения на Диске.
      </p>
