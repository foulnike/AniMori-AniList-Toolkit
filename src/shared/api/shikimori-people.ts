 ...
 *
 * Раздел называет вызывающий, и параметром он остаётся намеренно: приложение
 * спрашивает только `animes`, а юзерскрипт живёт на страницах AniList, где есть
 * и манга. Прибей раздел словом — и номер манги повёл бы в раздел аниме,
 * то есть к составу совсем другого тайтла.
 */
