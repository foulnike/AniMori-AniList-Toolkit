...
export interface DbStats {
   ...
   *
   * Ноль здесь — не забытый счётчик, а правда: карточка на диск сейчас
   * не ложится вовсе, и каждый показ страницы тайтла стоит запроса к AniList.
   * Появятся записи под этим префиксом — счётчик оживёт сам.
   */
  media: number
