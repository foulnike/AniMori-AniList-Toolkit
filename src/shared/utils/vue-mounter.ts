...
//
// Обращений к GM_*, хранилищу и сети здесь нет сознательно, равно как и связей
// с прикладными модулями скрипта: модуль принадлежит общему ядру.
...
/**
 * Снимает вся. Вызывается только при полном разборе скрипта (shutdownLifecycle),
